...
# image_folders="/home/ydubf/imbalanced-regression/poster_score/poster_downloads"
# data_paths="/home/ydubf/imbalanced-regression/poster_score/train.jsonl"
...
# ---------------------------------------------using this data jsonl--------------------------------------
data_paths="/ssong/250010214/MLLM_regression/dataset/BoneAge/boneage_train.jsonl"
image_folders="/ssong/250010214/MLLM_regression/dataset/BoneAge/boneage_resize"
# ---------------------------------------------------------------------------------------------------------
...
# export EXP_NAME="Qwen2.5-VL-3B-Instruct-reg-lora-Movie-preciserank-samplemean-4generation-bz16-global-ccc-only-4generation-bz16-4epoch"
...
# ===========================this is BoneAge Dataset==============================
export EXP_NAME="Qwen2.5-VL-7B-Instruct-reg-lora-BoneAge-preciserank-samplemean-4generation-bz24-global-ccc-only-5epoch"
